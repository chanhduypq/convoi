...
{	
	const CSS_FIRST_PAGE='paginate_button';
	const CSS_LAST_PAGE='paginate_button';
	const CSS_PREVIOUS_PAGE='paginate_button';
	const CSS_NEXT_PAGE='paginate_button';
	const CSS_INTERNAL_PAGE='paginate_button';
	...
	protected function createPageButton($label,$page,$class,$hidden,$selected)
	{
		...
		return '<li class="'.$class.'">'.CHtml::link($label,$this->createPageUrl($page), array())."</li>";
	}
}
...
class NumberToWords extends CApplicationComponent {
    ...
    public function convert_number_to_words($number, $language) {
        ...
        switch (true) {
            ...
            case $number < 1000:
                ...
                if ($remainder) {
                    $string .= $conjunction . $this->convert_number_to_words($remainder, $language);
                }
                break;
            default:
                ...
                if ($remainder) {
                    ...
                    $string .= $this->convert_number_to_words($remainder, $language);
                }
                break;
        }

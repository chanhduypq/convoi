...
class Image extends CApplicationComponent {
     ...
     * @return array 
     */
    public function echoImage($image_path, $width_for_view, $height_for_view, $order = "width",$html_option=array()) {
        ...
        if ($image_path[0] != '/') {
            ...
            if (!file_exists($document_root. $image_path)||!is_file($document_root.$image_path)) {
                echo "";
                return;
            }
            $url = $image_path;

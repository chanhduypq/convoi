...
//         $mail->CharSet='UTF-8';
//        $mail->SetFrom("chanhduypq@gmail.com", 'From NAme');
//        $mail->Subject    = "đang thử tiếng việt nè. trời ơi";
//        $mail->MsgHTML("<b>sdfsdf</b><br><i>iiiiii</i>");
//        $mail->AddAddress("tue12a31218@yahoo.com", "");
//        $content=  file_get_contents("a.pdf");
//        $mail->AddStringAttachment($content,'demo.pdf');
//        if(!$mail->Send()) {
 ...
 * @package PHPMailer
 */
class PHPMailer extends CApplicationComponent {

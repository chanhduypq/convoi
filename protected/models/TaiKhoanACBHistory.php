 ...
 * 
 */
class TaiKhoanACBHistory extends CActiveRecord {
    ...
    public function afterFind() {
        ...
        if($this->type==  TaiKhoanACB::TIEN_MAT){
            $this->tm_ck_khac="Tiền mặt";
        }
        else if($this->type==TaiKhoanACB::CHUYEN_KHOAN){
            $this->tm_ck_khac="Chuyển khoản";
        }
        else if($this->type==TaiKhoanACB::OTHER){

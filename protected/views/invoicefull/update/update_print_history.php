<div id="div-savefix">
    ...
    <li class="li_title2 bill">Nội dung</li>
    <li class="li_title3 bill">Liên 1</li>
    <li class="li_title4 bill">Liên 2</li>
    ...
    if(is_array($created_user)&&  count($created_user)>0&&$created_user['danh_xung']!=""){
        ...
        <li title="" class="li_raw2 bill"><div>Tạo mới</div></li>
        <li class="li_raw3 bill">X</li>
        <li class="li_raw4 bill">X</li>
        <li class="clearfix"></li>
    <?php     
    }
    foreach ($histoty_array as $value) {  
        ...
        <li title="<?php echo $value['reason']; ?>" class="li_raw2 bill"><div class="link" id="<?php echo $value['id']; ?>"><?php echo FunctionCommon::crop($value['reason'], 25, true); ?></div></li>
        <li class="li_raw3 bill"><?php echo $value['count_lien1']; ?></li>
        <li class="li_raw4 bill"><?php echo $value['count_lien2']; ?></li>
        <li class="clearfix"></li>
        <?php
    }
    ?>

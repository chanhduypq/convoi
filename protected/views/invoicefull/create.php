...
$this->renderPartial('//invoicefull/create/validate');
...
<?php 
$this->renderPartial('//invoicefull/create/event_submit',array('bill_number'=>$bill_number));
$this->renderPartial('//invoicefull/create/event_select_change');

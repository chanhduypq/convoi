<div id="dialog-modal-noidia_quocte" style="display: none;">
    <div class="edit-KH" id="khachhang">    
        ...
        <?php
        $rows=  SocaiFull::model()->findAll("giao_dich='Hóa đơn thương mại' and bill_id is null");
        ?>
...
<!--                <select id="tam_ung" style="width: 300px;">
                ...
                foreach ($rows as $row){
                ?>                    
                <option value="<?php echo $row->id;?>"><?php echo $row->created_at.' | '.$row->thu.' | '.  FunctionCommon::crop($row->content, 70, true) ;?></option>
                <?php
                }
                ?>
            </select>-->

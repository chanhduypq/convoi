...
/*@font-face {
    font-family: 'Roboto';
    src: url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Regular-webfont.eot');
    src: url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Regular-webfont.eot?#iefix') format('embedded-opentype'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Regular-webfont.woff') format('woff'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Regular-webfont.ttf') format('truetype'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Regular-webfont.svg#RobotoRegular') format('svg');
    font-weight: normal;
    font-style: normal;
}
...
@font-face {
    font-family: 'Roboto';
    src: url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Italic-webfont.eot');
    src: url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Italic-webfont.eot?#iefix') format('embedded-opentype'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Italic-webfont.woff') format('woff'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Italic-webfont.ttf') format('truetype'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Italic-webfont.svg#RobotoItalic') format('svg');
    font-weight: normal;
    font-style: italic;
}
...
@font-face {
    font-family: 'Roboto';
    src: url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Bold-webfont.eot');
    src: url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Bold-webfont.eot?#iefix') format('embedded-opentype'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Bold-webfont.woff') format('woff'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Bold-webfont.ttf') format('truetype'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Bold-webfont.svg#RobotoBold') format('svg');
    font-weight: bold;
    font-style: normal;
}
...
@font-face {
    font-family: 'Roboto';
    src: url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-BoldItalic-webfont.eot');
    src: url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-BoldItalic-webfont.eot?#iefix') format('embedded-opentype'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-BoldItalic-webfont.woff') format('woff'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-BoldItalic-webfont.ttf') format('truetype'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-BoldItalic-webfont.svg#RobotoBoldItalic') format('svg');
    font-weight: bold;
    font-style: italic;
}
...
@font-face {
    font-family: 'Roboto';
    src: url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Thin-webfont.eot');
    src: url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Thin-webfont.eot?#iefix') format('embedded-opentype'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Thin-webfont.woff') format('woff'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Thin-webfont.ttf') format('truetype'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Thin-webfont.svg#RobotoThin') format('svg');
    font-weight: 200;
    font-style: normal;
}
...
@font-face {
    font-family: 'Roboto';
    src: url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-ThinItalic-webfont.eot');
    src: url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-ThinItalic-webfont.eot?#iefix') format('embedded-opentype'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-ThinItalic-webfont.woff') format('woff'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-ThinItalic-webfont.ttf') format('truetype'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-ThinItalic-webfont.svg#RobotoThinItalic') format('svg'); (under the Apache Software License). 
    font-weight: 200;
    font-style: italic;
}
...
@font-face {
    font-family: 'Roboto';
    src: url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Light-webfont.eot');
    src: url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Light-webfont.eot?#iefix') format('embedded-opentype'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Light-webfont.woff') format('woff'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Light-webfont.ttf') format('truetype'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Light-webfont.svg#RobotoLight') format('svg');
    font-weight: 100;
    font-style: normal;
}
...
@font-face {
    font-family: 'Roboto';
    src: url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-LightItalic-webfont.eot');
    src: url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-LightItalic-webfont.eot?#iefix') format('embedded-opentype'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-LightItalic-webfont.woff') format('woff'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-LightItalic-webfont.ttf') format('truetype'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-LightItalic-webfont.svg#RobotoLightItalic') format('svg');
    font-weight: 100;
    font-style: italic;
}
...
@font-face {
    font-family: 'Roboto';
    src: url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Medium-webfont.eot');
    src: url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Medium-webfont.eot?#iefix') format('embedded-opentype'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Medium-webfont.woff') format('woff'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Medium-webfont.ttf') format('truetype'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-Medium-webfont.svg#RobotoMedium') format('svg');
    font-weight: 300;
    font-style: normal;
}
...
@font-face {
    font-family: 'Roboto';
    src: url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-MediumItalic-webfont.eot');
    src: url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-MediumItalic-webfont.eot?#iefix') format('embedded-opentype'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-MediumItalic-webfont.woff') format('woff'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-MediumItalic-webfont.ttf') format('truetype'),
         url('<?php echo Yii::app()->theme->baseUrl; ?>/fonts/roboto/Roboto-MediumItalic-webfont.svg#RobotoMediumItalic') format('svg');
    font-weight: 300;
    font-style: italic;
}*/

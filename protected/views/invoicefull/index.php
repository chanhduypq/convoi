<h1>Thống kê hóa đơn bán hàng<?php if($all_time_common=='0') echo ": $start_date_common - $end_date_common";?></h1>

<table class="title-HD1 sort">
    <tbody id="listing_container">
        <tr class="title-HD sort">
            <td class="title-HDli title-HDliw10 bill_number" title="Số hóa đơn">Hóa đơn</td>
            <td class="title-HDli title-HDliw10 date created_at">Ngày</td>
            <td class="title-HDli title-HDliw30 short_hand_name__full_name">Khách hàng</td>
            ...
            <td class="title-HDli title-HDliw10 count_lien1">Liên 1</td>
            <td class="title-HDli title-HDliw10 count_lien2">Liên 2</td>
        </tr>
        <?php 
        $this->renderPartial('//invoicefull/data_list',array('items'=>$items,'action'=>$action));
        ?>
    </tbody>
    <tfoot>
        <?php $this->renderPartial('//render_partial/common/distance_tbody_thead_for_list_page',array('colspan'=>'7'));?>
        <tr class="all-HD">
            ...
            <td class="all-HDli row0-HDliw10">&nbsp;</td>
            <td class="all-HDli row0-HDliw10" style="border-left: none;">&nbsp;</td>
        </tr>
    </tfoot>
</table>
...
$this->renderPartial('//invoicefull/index/print');
$this->renderPartial('//invoicefull/index/print_time_history');
...
//$this->renderPartial('//invoicefull/index/sort');
$this->renderPartial('//render_partial/common/sort',array('session_key'=>'invoice_list_sort','field_array'=>array(
                                                                            'bill_number',
                                                                            'created_at',
...
$this->renderPartial('//invoicefull/index/popup_for socai');
?>
<script type="text/javascript">
    jQuery(function ($){
        $("body").delegate("td.cursor1 a", "click", function() {
            ...
            submit_form_common("<?php echo $this->createUrl('/customerfull/index'); ?>","<?php echo $this->createUrl("/ajax/search"); ?>");
        });

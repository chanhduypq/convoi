...
<form id="update_bill" method="POST">
    ...
    <div id="mauHD">
        ...
        <!-- Div Customer info -->
        <?php 
        $this->renderPartial('//invoicefull/update/customer_info_html',array('invoicefull_model'=>$invoicefull_model,'payment_method'=>$payment_method,'payment_method_id'=>$invoicefull_model->payment_method_id));
        ?>
        ...
        <li class="clearfix"></li>        
        <?php $this->renderPartial('//invoicefull/update/update_print_history',array('histoty_array'=>$histoty_array,'created_user'=>$created_user));?>
    </div>
...
$this->renderPartial('//invoicefull/update/validate');
$this->renderPartial('//invoicefull/event/event_click');
$this->renderPartial('//invoicefull/update/event_select_change');
$this->renderPartial('//invoicefull/event/event_keyup');
$this->renderPartial('//invoicefull/update/event_submit',
                       array(
...
$this->renderPartial('//invoicefull/update/invoice_history_detail');     

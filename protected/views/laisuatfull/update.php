...
<!--                <select name="payment_method" style="width: 200px;">
        ...
        <li class="clearfix"></li>        
        <?php $this->renderPartial('//laisuatfull/update/update_print_history',array('update_histoty_array'=>$update_histoty_array,'created_user'=>$created_user));?>
    </div>
...
$this->renderPartial('//laisuatfull/update/event_submit');
?>

<h1>Thống kê lãi suất<?php if($all_time_common=='0') echo ": $start_date_common - $end_date_common";?></h1>
<table class="title-HD1 sort">
    <tbody id="listing_container">
        <tr class="title-HD sort">
            ...
            <td class="title-HDli title-HDliw60 description">Nội dung</td>  
            <td class="title-HDli title-HDliw20 sum_and_sumtax_number">Tổng tiền</td>
              
        </tr>
        <?php $this->renderPartial('//laisuatfull/data_list',array('items'=>$items,'action'=>$action));?> 
    </tbody>
    <tfoot>
        ...
        <tr class="all-HD">
            ...
            <td class="all-HDli row0-HDliw60"></td>
...
$this->renderPartial('//render_partial/common/sort',array('session_key'=>'lai_suat_list_sort','field_array'=>array(
                                                                            'stt',
                                                                            'created_at',
...
$this->renderPartial('//laisuatfull/index/popup_for socai'); 
?>

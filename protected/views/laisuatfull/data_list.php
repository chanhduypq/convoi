...
if(count($items)>0){
    foreach ($items as $item) {
        ...
        <tr class="row-HD heightauto">
            <td class="row0-HDli row0-HDliw10 cursor"><a href="<?php echo $this->createUrl('/laisuatfull/'.$action.'/id/'.$item->id);?>"><?php echo $item->stt;?></a></td>
            <td class="row0-HDli row0-HDliw10 date"><?php echo $item->created_at;?></td>
            <td class="row0-HDli row0-HDliw60 row0-HDli0"><p class="p1"><?php echo nl2br($item->description);?></p></td>            

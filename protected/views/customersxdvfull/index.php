...
<table class="title-HD1 sort">
    <tbody id="listing_container">
        ...
        <?php $this->renderPartial('//customersxdvfull/data_list',array('items'=>$items));?> 
    </tbody>
    <tfoot>
...
$this->renderPartial('//render_partial/common/sort',array('session_key'=>'customer_sxdv_list_sort','field_array'=>array(
        ...
        $("body").delegate("td.cursor", "click", function() {
            if($(this).find("a").length==1){//link số hóa đơn/ số tờ khai
                if ($(this).find("a").eq(0).hasClass("invoice")) {//link đến page hóa đơn
                    ...
                    action_for_form_common="<?php echo $this->createUrl('/sxdvfull/index'); ?>";
                }                

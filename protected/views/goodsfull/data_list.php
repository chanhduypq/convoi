...
if(count($items)>0){
    foreach ($items as $item) {
        ...
        ?>
        <tr class="row-HD">
            <td class="row0-HDli row0-HDliw50 row0-HDli0<?php echo $class_for_click_for_popup_edit;?>" id="<?php echo $item->goodsunit_id;?>" title="<?php echo $item->goods_full_name;?>">
                <p class="pcty">
            ...
            <td class="row0-HDli row0-HDliw5 row0-HDli0-r<?php if($item->so_hoa_don!='0'){?> cursor<?php }?>">
                ...
                ?>
                <a class="submit invoice"><?php echo $item->so_hoa_don;?></a>
                <?php
                }
                else{
            ...
            <td class="row0-HDli row0-HDliw5 row0-HDli0-r<?php if($item->so_khach_hang!='0'){?> cursor<?php }?>">
                ...
                ?>
                <a class="submit customer"><?php echo number_format($item->so_khach_hang, 0, ",", ".");?></a>
                <?php
                }
                else{

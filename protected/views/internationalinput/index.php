<h1>Thống kê tờ khai<?php if($all_time_common=='0') echo ": $start_date_common - $end_date_common";?></h1>
<table class="title-HD1 sort">
    <tbody id="listing_container">
        <tr class="title-HD sort">
            <td class="title-HDli title-HDliw15 bill_number">Tờ khai</td>
            ...
            <td class="title-HDli title-HDliw15 sum_number">Tổng tiền</td>
            <td class="title-HDli title-HDliw15 tax_sum_number">Thuế</td>
            <td class="title-HDli title-HDliw15 description">Ghi chú tờ khai</td>    
        </tr>
        <?php $this->renderPartial('//internationalinput/data_list',array('items'=>$items,'action'=>$action));?> 
    </tbody>
    <tfoot>
        <?php $this->renderPartial('//render_partial/common/distance_tbody_thead_for_list_page',array('colspan'=>'6'));?>
        <tr class="all-HD">
            <td class="all-HDli row0-HDliw15"><?php echo $bill_count;?></td>
...
$this->renderPartial('//render_partial/common/sort',array('session_key'=>'international_input_list_sort','field_array'=>array(
                                                                            'bill_number',
                                                                            'created_at',
...
$this->renderPartial('//internationalinput/index/popup_for socai');  
?>
...
<script type="text/javascript">
    jQuery(function ($){
        $("body").delegate("td.cursor1 a", "click", function() {
            ...
            submit_form_common("<?php echo $this->createUrl('/international/index'); ?>","<?php echo $this->createUrl("/ajax/search"); ?>");
        });

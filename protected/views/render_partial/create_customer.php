...
<script type="text/javascript">
    ...
    ?>    
    title_of_popup='<?php echo $title_of_popup;?>';
        ...
        $("#add_customer").click(function() {
            ...
            jQuery("#dialog-modal-customer").dialog({
                ...
                open: function(event, ui) {
                    $("form#form_customer").trigger('reset');
                    $('div.error').html('').hide();
        ...
        function saveCustomer() {
            ...
            $.ajax({ 
                ...
                data: {
                    ...
                    tax_code_chinhanh:$('input[name="tax_code_chinhanh"]').val(),
                    ...
                    short_hand_name:$('input[name="short_hand_name"]').val(),
                    is_submit:'1',
                    type:'<?php echo $type;?>',

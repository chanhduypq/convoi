...
<script type="text/javascript">
    ...
    if($type==Branch::CUSTOMER){
        ...
        $title_of_popup='Sửa thông tin khách hàng';
    }
        ...
        $.ajax({ 
            ...
            success: function(data, textStatus, jqXHR) {
                if($.trim(data)!=''){
                    ...
                    $('input[name="tax_code_chinhanh"]').val(data.tax_code_chinhanh);
                    $('input[name="address"]').val(data.address);
                    $('input[name="email"]').val(data.email);
                    $('input[name="phone"]').val(data.phone);
                    $('select[name="first_name"]').val(data.first_name);
            ...
            delay(function(){
                ...
                $.ajax({ 
                    ...
                    data: {
                        ...
                        tax_code_chinhanh:$('#khachhang_edit input[name="tax_code_chinhanh"]').val(),
                        ...
                        first_name:$('#khachhang_edit select[name="first_name"]').val(),

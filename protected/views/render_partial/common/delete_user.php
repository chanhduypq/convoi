...
<script type="text/javascript">
    jQuery(function($) {
                ...
                buttons: {
                    "Có": function() {
                      ...
                      $.ajax({ 
                          async: false,
                          cache: false,
                            url: '<?php echo $this->createUrl('/user/delete'); ?>/id/'+id,                
                            success: function(data, textStatus, jqXHR) {
                                submit_form_common('<?php echo $this->createUrl('/user/index');?>','<?php echo $this->createUrl("/ajax/search"); ?>');                    
                            }
                        });
                    },
                    "Không": function() {
        ...
        $("body").delegate("td.cancel_user", "click", function() {

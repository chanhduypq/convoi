<script type="text/javascript">    
    jQuery(function($) {        
<?php
$session_sort = Yii::app()->session['goods_input_list_sort'];
...
else if (strpos($session_sort, "so_to_khai")!== false) {
    echo "$('.so_to_khai').addClass('sort');";
    if (strpos($session_sort, "ASC") === FALSE) {
        echo "$('.so_to_khai').addClass('down');";
    } else {
        echo "$('.so_to_khai').addClass('up');";
    }
}
...
else if (strpos($session_sort, "so_nguoi_nuoc_ngoai")!== false) {
    echo "$('.so_nguoi_nuoc_ngoai').addClass('sort');";
    if (strpos($session_sort, "ASC") === FALSE) {
        echo "$('.so_nguoi_nuoc_ngoai').addClass('down');";
    } else {
        echo "$('.so_nguoi_nuoc_ngoai').addClass('up');";
    }
}

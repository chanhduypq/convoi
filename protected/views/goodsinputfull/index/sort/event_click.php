<script type="text/javascript">
    ...
    jQuery(function($) {
        ...
        $("div.title-HD.sort li.title-HDli").click(function() {
            ...
            else if($(this).hasClass("so_to_khai")){
                field="so_to_khai";
            }
            else if($(this).hasClass("so_khach_hang")){
                field="so_khach_hang";
            }
            else if($(this).hasClass("so_nguoi_nuoc_ngoai")){
                field="so_nguoi_nuoc_ngoai";
            }
            else if($(this).hasClass("tong_tien_number")){
                field="tong_tien_number";
            }
            sort("<?php echo Yii::app()->controller->id;?>",field,"goods_input_list_sort");           
        });

...
if(count($items)>0){
    foreach ($items as $item) {
        ...
        <tr class="row-HD">
            <td class="row0-KHli row0-HDliw70 row0-HDli0<?php echo $class_for_click_for_popup_edit;?>" id="<?php echo $item->branch_id1;?>">
                <p class="pcty">
                    <b>
            ...
            <td class="row0-KHli row0-HDliw20 row0-HDli0-rb<?php echo $class_append;?>"<?php echo $title_for_delete;?>><?php echo number_format($item->tong_tien,0,",",".");?></td>               

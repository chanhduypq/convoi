...
<table class="title-HD1 sort">
    <tbody id="listing_container">
        ...
        <?php 
        $this->renderPartial('//sxdvfull/data_list',array('items'=>$items,'action'=>$action));
        ?>
    </tbody>
    <tfoot>
...
$this->renderPartial('//sxdvfull/index/print');
$this->renderPartial('//sxdvfull/index/print_time_history');
...
//$this->renderPartial('//sxdvfull/index/sort');
$this->renderPartial('//render_partial/common/sort',array('session_key'=>'sxdv_list_sort','field_array'=>array(
                                                                            'bill_number',
                                                                            'created_at',
...
$this->renderPartial('//sxdvfull/index/popup_for socai');
?>
<script type="text/javascript">
    jQuery(function ($){
        $("body").delegate("td.cursor1 a", "click", function() {
            ...
            submit_form_common("<?php echo $this->createUrl('/customersxdvfull/index'); ?>","<?php echo $this->createUrl("/ajax/search"); ?>");
        });

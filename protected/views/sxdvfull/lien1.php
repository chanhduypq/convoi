...
<link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl; ?>/css/font_roboto.css" />
...
.maintop-wraptop1{
	width: 1760px; 
	height: 720px; 
        <?php if(strlen($invoicefull_model->address)>140){?>
	background: url(<?php echo Yii::app()->theme->baseUrl; ?>/images/hoa_don_new/bg-1a1.jpg) center top no-repeat;
        <?php } else{?>
...
.maintop-wraptop2{
	...
	height: 720px; 
        <?php if(strlen($invoicefull_model->address)>140){?>
	background: url(<?php echo Yii::app()->theme->baseUrl; ?>/images/hoa_don_new/bg-2a1.jpg) center top no-repeat;
        <?php } else{?>
...
.div-products .div-raw ul li input{
	...
	<div class="maintop-wraptop<?php echo trim($lien);?>">
        ...
        <div class="div-customer">
            <ul>
                ...
                <li class="li-c2">&nbsp;</li>
                <li class="li-address"><?php echo $invoicefull_model->address; ?>
                    <!--<input type="text" name="add" value="<?php echo $invoicefull_model->address; ?>" class="input-customer" />-->
                </li>
                <li class="clearfix"></li>
                <li class="li-c3">&nbsp;</li>
        ...
        <div class="div-products">
        	...
        	<div class="div-raw">
                    <ul>
                        ...
                        <li class="li-raw-2"><input type="text" name="namepro" value="<?php echo $bill_detail->sxdv_name; ?>" class="li-raw-2-input" /></li>
                        <li class="li-raw-3"><input type="text" name="dvt" value="<?php echo $bill_detail->sxdv_donvi; ?>" class="li-raw-3-input" /></li>

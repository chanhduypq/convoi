...
if(count($items)>0){
    foreach ($items as $item) {
        ...
        <tr class="row-HD heightauto">
            <td class="row0-HDli row0-HDliw10"><a href="<?php echo $this->createUrl('/invoiceinputfull/'.$action.'/id/'.$item->id);?>"><?php echo $item->bill_number;?></a></td>
            ...
            <td class="row0-HDli row0-HDliw20 row0-HDli0"><p class="p1"><?php echo nl2br($item->description);?></p></td>            

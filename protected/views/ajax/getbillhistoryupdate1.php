    ...
    foreach ($bill_details as $bill_detail) {
        ...
        <div class="div-margin">
            <div class="div-pro1">
                ...
                <li class="proname">
                    <input type="text" disabled="disabled" class="cus-auto18-input" value="<?php echo $bill_detail['sxdv_name']; ?>"/>
                ...
                <li class="pro-13-1select">
                    <input type="text" disabled="disabled" class="cus-auto18-input" value="<?php echo $bill_detail['sxdv_donvi']; ?>"/>

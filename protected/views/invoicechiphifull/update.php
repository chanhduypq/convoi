...
<form id="update_bill" method="POST">
    ...
    <div id="mauHD">
        ...
        <?php 
        $this->renderPartial('//invoicechiphifull/update/supplier_info_html',array('invoicefull_model'=>$invoicefull_model,'payment_method'=>$payment_method,'payment_method_id'=>$invoicefull_model->payment_method_id));
        ?>       
        ...
        <li class="clearfix"></li>        
        <?php $this->renderPartial('//invoicechiphifull/update/update_print_history',array('update_histoty_array'=>$update_histoty_array,'created_user'=>$created_user));?>
    </div>
...
$this->renderPartial('//invoicechiphifull/update/validate');
$this->renderPartial('//invoicechiphifull/event/event_keyup');
$this->renderPartial('//invoicechiphifull/update/event_submit');

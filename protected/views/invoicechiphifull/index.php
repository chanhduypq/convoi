<h1>Thống kê hóa đơn chi phí<?php if($all_time_common=='0') echo ": $start_date_common - $end_date_common";?></h1>
<table class="title-HD1 sort">
    <tbody id="listing_container">
        <tr class="title-HD sort">
            ...
            <td class="title-HDli title-HDliw40 short_hand_name__full_name"><?php echo Yii::app()->params['label_for_supplier'];?></td>
            ...
            <td class="title-HDli title-HDliw15 description">Ghi chú hóa đơn</td>    
        </tr>
        <?php $this->renderPartial('//invoicechiphifull/data_list',array('items'=>$items,'action'=>$action));?> 
    </tbody>
    <tfoot>
...
$this->renderPartial('//render_partial/common/sort',array('session_key'=>'invoice_chiphi_list_sort','field_array'=>array(
                                                                            'bill_number',
                                                                            'created_at',
...
$this->renderPartial('//invoicechiphifull/index/popup_for socai'); 
?>

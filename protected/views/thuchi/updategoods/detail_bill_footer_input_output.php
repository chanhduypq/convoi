<div id="div-margin">
    <div class="div-pro1">
        ...
        <li class="all-total3" style="width: 60%">
            <span class="p_left" id="sum_sum_and_tax"><?php echo $sum_all; ?></span>  
...
<script type="text/javascript">
     ...
     */
    var init_sum=<?php echo str_replace(".", "", $sum) ; ?>;
    var init_tax_sum=<?php echo str_replace(".", "", $tax_sum); ?>;

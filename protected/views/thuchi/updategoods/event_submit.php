<script type="text/javascript">
    jQuery(function($) {
        ...
        $("#submit").click(function() {
            ...
            //chưa ghi log nên k popup lên lý do nên do sumit thẳng luôn nên cho 2 dòng sau vào, và comment những dòng code dưới
...
<?php 
$this->renderPartial('//thuchi/updategoods/popup_for_submit'); 
?>
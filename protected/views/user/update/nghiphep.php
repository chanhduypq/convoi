...
//            flag=false;  
//        }
//        if($.trim($('input[name="so_ngay_nghi"]').val())==''){
...
//                                data=$.parseJSON(data);
//                                
//                                $('#khachhang1 input[name="so_ngay_nghi"]').val(data.so_ngay_nghi);
...
//}
//$stt1++;
//$this->renderPartial('//user/update/create_update_nghiphep',array('stt1'=>$stt1));
?>
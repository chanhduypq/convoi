...
class CButtonColumn extends CGridColumn
{
	 ...
	 */
	public $htmlOptions=array('class'=>'button-column menu-action rounded-btn', 'nowrap' => 'nowrap');
	/**
	 ...
	 */
	public $viewButtonOptions=array('class'=>'view btn menu-icon vd_bd-green vd_green');
	 ...
	 */
	public $updateButtonOptions=array('class'=>'update btn menu-icon vd_bd-yellow vd_yellow');
	 ...
	 */
	public $deleteButtonOptions=array('class'=>'delete btn menu-icon vd_bd-red vd_red');
	/**
	...
	protected function initDefaultButtons()
	{
		if($this->viewButtonLabel===null)
			$this->viewButtonLabel=Yii::t('zii','Xem');
		if($this->updateButtonLabel===null)
			$this->updateButtonLabel=Yii::t('zii','Sửa');
		if($this->deleteButtonLabel===null)
			$this->deleteButtonLabel=Yii::t('zii','Xóa');
		if($this->viewButtonImageUrl===null)
			$this->viewButtonImageUrl='<i class="fa fa-eye"></i>';
		if($this->updateButtonImageUrl===null)
			$this->updateButtonImageUrl='<i class="fa fa-pencil"></i>';
		if($this->deleteButtonImageUrl===null)
			$this->deleteButtonImageUrl='<i class="fa fa-times"></i>';
		if($this->deleteConfirmation===null)
			$this->deleteConfirmation=Yii::t('zii','Bạn có chắc xóa không?');
...
EOD;
	...
	protected function renderButton($id,$button,$row,$data)
	{
		...
		if(isset($button['imageUrl']) && is_string($button['imageUrl']))
			echo CHtml::link($button['imageUrl'],$url,$options);
		else
